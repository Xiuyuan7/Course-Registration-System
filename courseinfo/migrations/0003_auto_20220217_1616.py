# Generated by Django 3.2.5 on 2022-02-17 22:16
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('courseinfo', '0002_auto_20220217_1539'),
    ]
    ...
    operations = [
        ...
        migrations.AlterModelOptions(
            name='semester',
            options={'ordering': ['year__year', 'period__period_name']},
        ),
        migrations.AlterModelOptions(
            name='student',
            options={'ordering': ['last_name', 'first_name', 'disambiguator']},
        ...
        migrations.AddConstraint(
            model_name='semester',
            constraint=models.UniqueConstraint(fields=('year', 'period'), name='unique semester'),
        ),
        migrations.AddConstraint(
            model_name='student',
