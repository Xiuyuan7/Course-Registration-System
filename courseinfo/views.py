...
class InstructorList(View):
    ...
    def get(self, request):
        ...
        paginator = Paginator(instructors, self.paginate_by)
...
class InstructorUpdate(View):
    ...
    def get(self, request, pk):
        ...
        context = {'form': self.form_class(instance=instructor), 'instructor': instructor, }
        return render(request, self.template_name, context)
...
class SectionUpdate(View):
    ...
    def get(self, request, pk):
        ...
        context = {'form': self.form_class(instance=section), 'section': section, }
        return render(request, self.template_name, context)
...
class CourseUpdate(View):
    ...
    def get(self, request, pk):
        ...
        context = {'form': self.form_class(instance=course), 'course': course, }
        return render(request, self.template_name, context)
...
class SemesterUpdate(View):
    ...
    def get(self, request, pk):
        ...
        context = {'form': self.form_class(instance=semester), 'semester': semester, }
        return render(request, self.template_name, context)
...
class StudentUpdate(View):
    ...
    def get(self, request, pk):
        ...
        context = {'form': self.form_class(instance=student), 'student': student, }
        return render(request, self.template_name, context)
...
class RegistrationUpdate(View):
    ...
    def get(self, request, pk):
        ...
        context = {'form': self.form_class(instance=registration), 'registration': registration, }
        return render(request, self.template_name, context)
